...
@section('title', "Galerías fotográficas subidas por: $user->display_name" )
@section('description', "Galerías fotográficas subidas por: $user->display_name")
@section('url', url('galerias/usuario', $user->uid))
...
@section('content')
  ...
  <div class="row">
    ...
    <div class="col-sm-8 col-md-8 content-body">
      <!--  main content -->
      <h1 class="title">
        <span>Galerías fotográficas subidas por: {{ $user->display_name }}</span>
      </h1>
      <br>
