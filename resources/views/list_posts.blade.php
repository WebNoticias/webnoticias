...
@section('title', "Web Noticias $city->name - Opinión" )
@section('description', "Web Noticias $city->name artículos en la categoría columnas de opinión")
@section('url', url('opinion'))
