  ...
  */
  methods: {
        ...
        if (! vm.validateFields()){
          ...
          if(vm.form === 'create'){
            ...
            .then(function (response) {
                ...
                vm.$Progress.finish();
                vm.closeNotification();
                vm.addNotification('Artículo registrado', 'success');
            })
            .catch(function (error) {
              vm.procError(error);
            });
    ...
    validateFields: function(){
        ...
        if (! this.post.title){
          this.$set( this.errors, 'title', 'Ingrese título de artículo');
          this.$refs.title.focus();
          return true;
        }

        if (! this.post.content){
          this.$set( this.errors, 'content', 'Ingrese contenido de artículo');
          return true;
        }

        if (! this.post.excerpt){
          this.$set( this.errors, 'excerpt', 'Ingrese Extracto/Fragmento de artículo');
        ...
        if (! this.post.author_id){
          this.$set( this.errors, 'author', 'Ingrese autor de artículo');
          return true;
        }
